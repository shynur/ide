...
RUN cd ~/.config/emacs; rm -rf .git; git clone --depth=1 --single-branch --branch=trunk --bare https://github.com/shynur/.emacs.d.git .git; git --git-dir=.git --work-tree=. reset --mixed HEAD
